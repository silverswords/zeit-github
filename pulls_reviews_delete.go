...
// PullsReviewsDetele deletes the specified pull request pending review.
func PullsReviewsDetele(w http.ResponseWriter, r *http.Request) {
	var (
		github struct {
...
t := c.Request.Header.Get("Authorization")
	...
	pull, _, err := client.Client.PullRequests.DeletePendingReview(ctx, github.Owner, github.Repo, github.Number, github.ReviewID)
	if err != nil {
